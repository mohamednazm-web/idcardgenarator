...
<br>
<h3 style="margin: auto; max-width: 400px; color: blue;" class="mb-1">Generate Id Card For Student</h3>
<div style="margin: auto; max-width: 900px; color: blur;">
        <div class="card jumbotron">
        <div class="card-body" style="background-color: #fff;">
            <form class="form" method="POST" action="id-card.php">
            <label for="exampleInputEmail1">Student Id Card No</label>
            <input class="form-control mr-sm-2" type="search" placeholder="Write Correct Id Card No." name="id_no">
...
<hr>
<button id="demo" class="downloadtable btn btn-secondary" onclick="downloadtable()"> Download Id Card</button>
</div>
